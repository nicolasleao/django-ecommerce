...
class AddToCart(View):
    ...
    def get(self, request, store_name, product_id):
        ...
        total_cart_items = add_item(request, store_name, product_id)
...
class RemoveFromCart(View):
    def get(self, request, store_name, product_id):
        ...
        remove_item(request, store_name, product_id)
        # Redirect to shopping cart
        return redirect('shopping-cart', store_name)


class UpdateItemQuantity(View):
    def get(self, request, store_name, product_id, quantity):
        ...
        update_item_quantity(request, store_name, product_id, quantity)
        total = calculate_cart_total(request, store_name)
